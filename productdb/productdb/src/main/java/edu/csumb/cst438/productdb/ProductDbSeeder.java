...
public class ProductDbSeeder implements CommandLineRunner{
    ...
    public void run(String... args) throws Exception {
        ...
        ,"Otter Plush",new Description( "It's an Otter" ), 25.99 ,5);
        ...
        ,"Giraffe Plush", new Description("It's a Girraffe" ),19.99,5);
        ...
        ,"CSUMB Monkey Plush Keychain",new Description("It's a plushy and a keychain" ), 10.99,5);
