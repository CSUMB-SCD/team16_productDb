...
public class ProductDbSeeder implements CommandLineRunner{
   @Autowired
    ...
    public void run(String... args) throws Exception {
        ...
        ,"Otter Plush",new Description( "It's an Otter" ),5,25.99);
        ...
        ,"Giraffe Plush", new Description("It's a Girraffe" ),5,19.99);
        ...
        ,"CSUMB Monkey Plush Keychain",new Description("It's a plushy and a keychain" ),5,10.99);
